...
Y = np.cumsum(np.fmax(X, 0.0)*dt, axis = 1) - 0.5*np.square(X)
DhY = np.fmax(X, 0.0)
DvY = -X
...
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = ":", label = r'$x(t)$')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "-", label = r'$\mathcal{D} f_2(t,x)$')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "--", label = 'PNN')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "-.", label = 'Sig')
plt.legend(loc = "upper left", ncol = 4)
plt.xlabel("Time")
...
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = ":", label = r'$x(t)$')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "-", label = r'$\mathscr{D} f_2(t,x)$')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "--", label = 'PNN')
plt.plot(tt, np.nan*np.ones(K), c = 'k', ls = "-.", label = 'Sig')
plt.legend(loc = "upper left", ncol = 4)
plt.xlabel("Time")
